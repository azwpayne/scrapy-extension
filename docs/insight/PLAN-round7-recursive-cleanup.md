...
| **SEC-5 case-sensitive Pulsar scheme** (`"Pulsar+SSL://"`) | Accepted scope — Pulsar accepts case-insensitive schemes; the round-6 guard matches lowercase. Documented in the round-6 commit `Not-tested:` trailer. |
