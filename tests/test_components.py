...
class TestBackendQueue:
    ...
    def test_pop_request(self, mock_connection_manager):
        ...
        mock_connection_manager.get_queue_backend().pop.return_value = b'{"url": "https://example.com", "callback": null}'
        queue = BackendQueue(
            connection_manager=mock_connection_manager,
            queue_name="test_queue",
        )
...
class TestBackendScheduler:
    ...
    def test_next_request(self, mock_connection_manager):
        ...
        mock_queue_backend.pop.return_value = b'{"url": "https://example.com", "callback": null}'
