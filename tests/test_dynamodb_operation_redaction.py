...
def _failing_storage_operation(
    ...
    if method_name == "store":
        ...
        return (
            lambda: backend.store(_MARKER, _MARKER.encode()),
            "store",
    ...
    if method_name == "retrieve":
        ...
        return (
            lambda: backend.retrieve(_MARKER),
            "retrieve",
