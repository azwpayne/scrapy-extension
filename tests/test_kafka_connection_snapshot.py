...
def test_common_config_keeps_verified_tls_after_validation_use_race(mocker) -> None:
    ...
    def mutate_after_validation(
        ...
        validate_kafka_transport_security(mode, security_protocol, ssl_check_hostname)
...
def test_unpublished_connect_snapshot_cannot_reach_concurrent_consumer(mocker) -> None:
